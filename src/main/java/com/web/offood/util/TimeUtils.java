...
public class TimeUtils {
    ...
    public static final String DATE_FORMAT_27 = "yyyyMMdd";
    public static final String DATE_FORMAT_28 = "dd";
    public static final String DATE_FORMAT_29 = "MM/yyyy";
    public static final String DATE_FORMAT_30 = "yyyy-MM-dd'T'HH:mm:ss";
    public static final String DATE_FORMAT_31 = "yyyy-MM-dd HH:mm:ss";
    ...
    public static String convertStringToString(
    ...
    public static int getSumDayInMonth(long time) {
        String start = "01" + convertTimeStampToString(time, DATE_FORMAT_22);
        long startTime = convertStringToTimeStamp(start, DATE_FORMAT_20);

        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(startTime);
        calendar.add(Calendar.MONTH, 1);

        return (int) ((calendar.getTimeInMillis() - startTime) / 86400000L);
    }

    public static int getSumDayFromTime(long time) {
        String start = "01" + convertTimeStampToString(time, DATE_FORMAT_22);
        long startTime = convertStringToTimeStamp(start, DATE_FORMAT_20);

        return (int) ((time - startTime) / 86400000L) + 1;
    }
    ...
    public static long roundHour(long time) {
        return convertDownTimeDayGMT7(time) + getHour(new Date(time)) * 60 * 60000L;
    }
    ...
    public static Timestamp convertToTimestamp(String time) {
        SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT_31, Locale.getDefault());
        try {
            Date date = format.parse(time);
            return new Timestamp(date.getTime());
        } catch (Exception e) {
            e.printStackTrace();
            throw new ApiException(ApiErrorCode.USER_NOT_EXIST);
        }
    }

    public static String convertLocalDateTimeToString(
            LocalDateTime localDateTime, String strFormatter) {
